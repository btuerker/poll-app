...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { expiration_date: @poll.expiration_date, question: @poll.question } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { expiration_date: @poll.expiration_date, question: @poll.question } }
